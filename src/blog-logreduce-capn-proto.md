...
- [Protobuf][protobuf], introduced by Google in 2001, doesn't support zero-copy access.
- [Thrift][thrift], introduced by Facebook in 2007, doesn't support zero-copy access.
- [Cap’n Proto][capnp], introduced by the former maintainer of Protobuf in 2013, designed for RPC system with zero-copy access.
- [Flatbuffers][flatbuffers], introduced by Google in 2014, designed for games with zero-copy access, data validation is a costly opt-in.
