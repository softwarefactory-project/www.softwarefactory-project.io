...
- the Service Account `monocle-operator-controller-manager`
...
and verify the logs of the `monocle-operator-controller-manager` pod:
...
The generated image can be found on the your locally and then can be push to the image registry via:
