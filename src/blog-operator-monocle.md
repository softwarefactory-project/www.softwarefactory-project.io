...
It was our first attempt working with Kubernetes Operators, at first we were astonished with the quantity of information and tools there are to start developing an Operator, [kubebuiler], [operator SDK], then which stack to use for the operator's development [helm], [ansible] or [go], and at the same time learning new things and finding out how Kubernetes works in more detail every day.
