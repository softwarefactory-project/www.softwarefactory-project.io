...
$ koji add-pkg sf-2.6-el7-build buildsys-macros-el7
...
$ pushd ~/koji-get/config && git add -A . && git commit -m"Add branches for sf-2.6" && git review && popd
...
$ ./zuul_koji_populate_target.py --distro-info sf-2.6.yaml
