...
This new release consolidates the previous release with updated packages and
minor features such as an improved update mechanism.
...
- rh-python35-zuul-3.3.1-2.el7 # TODO: wait for final package
