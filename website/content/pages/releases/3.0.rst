...
- A new component named "hound" can be added to the architecture to enable
  a code search service.
- A new component "DLRN" has been added. DLRN builds and maintains yum
  repositories by following upstream changes.
...
- rh-python35-python-packaging-16.8-6.el7
- rh-python35-python-passlib-1.7.0-8.el7
- rh-python35-python-pillow-4.3.0-1.el7
- rh-python35-python-psutil-5.4.3-1.el7
- rh-python35-python-pymod2pkg-0.11.0-1.el7
- rh-python35-python-renderspec-1.7.0-2.el7
- rh-python35-python-scikit-learn-0.19.1-1.el7
- rh-python35-python-sh-1.12.14-2.el7
...
- rh-python35-python-sphinxcontrib-httpdomain-1.6.1-1.el7
...
- rh-python35-rdopkg-0.46.3-1.el7
- rh-python35-scipy-0.19.1-1.el7
- rh-python35-zuul-3.0.0-22.20180312gitbb41b12.el7
- rh-python35-zuul-jobs-0.1-0.6.20180308gitd28c326.el7
- sf-config-3.0.1-1.el7
- sf-docs-3.0.3-1.el7
- sf-elements-0.5.0-2.el7
