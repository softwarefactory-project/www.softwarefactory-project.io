...
After a while, we spotted an issue, the CI jobs were failing without any known
...
As it was described in the error message above in the :ref:`Problem description` paragraph,
...
doing a test of etcd benchmark, where data dir will be poiting to the RAM disk.
