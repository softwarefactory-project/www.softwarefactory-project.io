...
Note that, most of the links, in this article, target *sftests.com*, that is
the default domain if you followed the *How to setup a Software Factory sandbox*
blog post to setup your sandbox. Make sure to adapt links if necessary.
