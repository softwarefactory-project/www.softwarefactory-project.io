...
the environment by following `manual <https://github.com/openstack-k8s-operators/install_yamls/tree/master/devsetup#crc-automation--tool-deployment>`__.
...
More information `here <https://github.com/crc-org/crc/wiki/Nested-virtualization-setup>`__.
...
on `Kind <https://kind.sigs.k8s.io/>`__ tool, which got a dedicated configuration
to enable `extraPortMapping <https://kind.sigs.k8s.io/docs/user/ingress/#setting-up-an-ingress-controller>`__.
