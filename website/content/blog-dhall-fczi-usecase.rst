...
- Not as simple as just edit a YAML file.

Pros
----

- Dhall-Zuul prevents wrong definition of Zuul's jobs. For instance a typo in an job's
  attribute or using a string as value attribute where a list of strings
  is expected will be catched by the Dhall compiler.
- Dhall IDE integration provides type checking and completion. For instance my IDE
