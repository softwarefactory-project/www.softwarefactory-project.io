...
validation by default. Therefor I decided to use Cap'n Proto as
...
Flatbuffers is also worth considering, it has a lower storage cost, but
it requires more work to verify that the data is safe to be processed.
