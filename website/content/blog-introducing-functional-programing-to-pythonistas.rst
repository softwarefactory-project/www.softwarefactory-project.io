...
with Haskell on Fedora][haskell-fedora] and `Haskell for python
developpers`_. I also demonstrated how we could use the language for
other use-cases such as documentation management and software factory
packages update.
